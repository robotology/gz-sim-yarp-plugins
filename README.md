...
| `gzyarp::Clock` | `gz-sim-yarp-clock-system` |  [`plugins/clock/README.md`](./plugins/clock/README.md)   | [`tutorial/clock`](./tutorial/clock) |
...
| `gzyarp::StereoDepthCamera` | `gz-sim-yarp-stereodepthcamera-system` | [Missing. If you need it please open an issue.](https://github.com/robotology/gz-sim-yarp-plugins/issues/new) | [`tutorial/stereodepthcamera`](./tutorial/stereodepthcamera) |
